...
public class VinhosController {
	...
	@PostMapping ("/novo")
	public ModelAndView salvar(@Valid Vinho vinho, BindingResult result, RedirectAttributes redirectAtt) {
		...
		redirectAtt.addFlashAttribute("mensagem", "Vinho salvo com sucesso!!!");
